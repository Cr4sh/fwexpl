...
#define DRV_CTL_PHYS_MEM_READ   0x01
#define DRV_CTL_PHYS_MEM_WRITE  0x02
#define DRV_CTL_PORT_READ       0x03
#define DRV_CTL_PORT_WRITE      0x04
#define DRV_CTL_PCI_READ        0x05
#define DRV_CTL_PCI_WRITE       0x06
#define DRV_CTL_SMI_INVOKE      0x07
...
typedef struct _REQUEST_BUFFER
{
    ...
    union
    {
        struct // for DRV_CTL_PHYS_MEM_READ
        {
            ULONG64 Address;
            ULONG Size;
            UCHAR Data[];
        ...
        struct // for DRV_CTL_PHYS_MEM_WRITE
        {
            ULONG64 Address;
            ULONG Size;
            UCHAR Data[];
